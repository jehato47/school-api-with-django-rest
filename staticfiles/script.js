	...
	var e = /(\d+(\.\d+)?)px/,
		c = {
			...
			fakeEvent: function(b, a, c, e) {
				...
				const n = document.createEvent(r);
				switch (r) {
					case "MouseEvents":
						n.initMouseEvent(
							a,
...
dat.controllers.NumberControllerBox = (function(f, a, d) {
	const e = function (c, b, f) {
		function q() {
			const a = parseFloat(n.__input.value);
	...
	d.extend(e.prototype, f.prototype, {
		updateDisplay: function() {
			const a = this.__input;
			let b;
			if (this.__truncationSuspended) b = this.getValue();
			else {
				b = this.getValue();
				const d = Math.pow(10, this.__precision);
				b = Math.round(b * d) / d;
			}
			a.value = b;
			return e.superclass.prototype.updateDisplay.call(this);
...
dat.controllers.NumberControllerSlider = (function(f, a, d, e, c) {
	...
	const p = function (c, e, d, f, u) {
		function A(c) {
			c.preventDefault();
			const e = a.getOffset(k.__background),
	...
	e.extend(p.prototype, f.prototype, {
		updateDisplay: function() {
			const a = (this.getValue() - this.__min) / (this.__max - this.__min);
...
dat.color.interpret = (function(f, a) {
	...
	return function() {
		e = !1;
		const b = 1 < arguments.length ? a.toArray(arguments) : arguments[0];
		a.each(c, function(c) {
			if (c.litmus(b))
				return (
...
dat.GUI = dat.gui.GUI = (function(f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
	...
	function t(a, c, h) {
		...
		if (h instanceof l) {
			const d = new q(h.object, h.property, {
				min: h.__min,
				max: h.__max,
				step: h.__step
			});
	...
	function L(a) {
		...
		g.addClass(f, "button");
		g.addClass(f, "revert");
		const r = (a.__preset_select = document.createElement("select"));
		...
		g.bind(r, "change", function() {
			for (let b = 0; b < a.__preset_select.length; b++)
		...
		const m = document.getElementById("dg-new-constructor");
		...
		g.bind(e, "click", function() {
			const b = prompt("Enter a new preset name.");
			b && a.saveAs(b);
		});
	...
	function E(a, b) {
		const c = a.__preset_select[a.__preset_select.selectedIndex];
	...
	k.extend(m.prototype, {
		...
		onResize: function() {
			const a = this.getRoot();
			if (a.scrollable) {
				const b = g.getOffset(a.__ul).top;
				let c = 0;
		...
		listen: function(a) {
			const b = 0 == this.__listening.length;
	...
	(dat.controllers.ColorController = (function(f, a, d, e, c) {
		...
		const q = function (f, n) {
			...
			function v(b) {
				b.preventDefault();
				const c = a.getWidth(t.__saturation_field),
					d = a.getOffset(t.__saturation_field);
				let e = (b.clientX - d.left + document.body.scrollLeft) / c;
			...
			function w(b) {
				b.preventDefault();
				const c = a.getHeight(t.__hue_field),
		...
		c.extend(q.prototype, f.prototype, {
			updateDisplay: function() {
				...
				this.__temp.a = 1;
				const l = 0.5 > this.__color.v || 0.5 < this.__color.s ? 255 : 0,
					p = 255 - l;
				c.extend(this.__field_knob.style, {
		...
		(dat.color.Color = (function(f, a, d, e) {
			...
			function q(b) {
				const c = a.rgb_to_hsv(b.r, b.g, b.b);
